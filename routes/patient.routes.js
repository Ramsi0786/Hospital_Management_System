...
router.get('/profile', (req, res) => res.render('patient/profile-settings', { patient: req.user, user: req.user, title: 'My Profile - Healora', currentPage: 'profile' }));
router.get('/profile-settings', (req, res) => res.render('patient/profile-settings', { patient: req.user, user: req.user, title: 'Profile Settings', currentPage: 'profile' }));
